...
/**
 * Takes that activates a bank card
 * 
 * @author Olivier B. OURA (baudolivier.oura@gmail.com)
 *
 */
public final class TkActivateCard implements Take {
	...
	public Response act(Request req) throws Exception {
		...
		try {
			...
			Logger.info(this, "Transaction (rrn=%s, pan=%s) : Surati asks %s to activate the card.", rrn, pan, Main.APP_NAME);
			
			Thread.sleep(100);
			
			Logger.info(this, "Transaction (rrn=%s, pan=%s) : %s activates the card.", rrn, pan, Main.APP_NAME);
